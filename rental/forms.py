...
class RentalUpdateForm(forms.ModelForm):
    class Meta:
        model = Rental
        fields = ['car', 'customer_name', 'customer_phone', 'pick_up_time', 'drop_off_time', 'location_category', 'town', 'rental_date', 'return_date', 'document_type', 'document_number', 'driver', 'status', 'commission_rate', 'vat_percentage', 'base_price', 'vat_amount', 'total_price']
        widgets = {
