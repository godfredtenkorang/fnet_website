...
class DriverForm(forms.ModelForm):
    class Meta:
        model = Driver
        fields = ['driver', 'first_name', 'last_name', 'licence_number', 'phone_number', 'license_issue_date', 'licence_expiry_date', 'is_available']
        widgets = {
