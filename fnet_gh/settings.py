"""
Django settings for fnet_gh project.
...
ALLOWED_HOSTS = ['.tlghana.com', '143.198.118.130', '127.0.0.1', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'my_site.views.categories',
            ],
        },
    },
]

WSGI_APPLICATION = 'fnet_gh.wsgi.application'
